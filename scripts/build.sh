...
# Génère les binaires iOS (.ipa) et Android (.aab) pour un client donné
#
...
# 4. Mettre à jour app.json pour Expo
echo ""
echo "⚙️  Step 4: Updating app.json..."
...
# 7. Générer QR code
echo ""
echo "📱 Step 7: Generating QR code..."
